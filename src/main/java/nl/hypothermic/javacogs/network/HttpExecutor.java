...
public class HttpExecutor {
	...
	public static final String USER_AGENT = "Javacogs/" + Javacogs.VERSION_MAJOR + "." + Javacogs.VERSION_MINOR + "." + Javacogs.VERSION_PATCH + " +https://github.com/hypothermic/javacogs";
